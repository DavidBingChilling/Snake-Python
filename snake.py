...
#Deleting the last part of the snake
...
def play_again():
    ...
    if game_over_flag:
        ...
        print("Can't play again during an active game.")
...
#Score
label= Label(window,text = "Score:{}".format(score),font = ('Fixedsys',40))
label.pack()
#Game board
...
window.bind('r', lambda event: play_again())
